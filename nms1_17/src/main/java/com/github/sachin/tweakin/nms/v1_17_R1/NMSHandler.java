...
public class NMSHandler extends NMSHelper{
    ...
    private static class FleePathFinder<T extends EntityLiving> extends PathfinderGoalAvoidTarget<T>{
        private int tick = 0;
    ...
    private static class FollowPathFinder extends PathfinderGoal{
